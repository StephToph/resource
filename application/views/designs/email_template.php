...
<style>
	...
	.mbtn .btn1{background-color: #EEE;}
</style>
</head>
...
<body>
	<div id="m_wrap"> 
        <div id="m_box">
            <div class="mhead">
                <div class="mlogo">
                    <img alt="" src="<?php echo base_url('assets/images/icon.png'); ?>" style="height:100px;" />
                </div>
				<?php echo $subhead; ?>
            </div>
        ...
        <div class="mfooter">
            <b><?php if(!empty($brand_name)){echo $brand_name;} else {echo app_name;} ?> Team</b><br />

$(function () {
	...
	$(form).submit(function (event) {
		...
		$(formMessages).html('<div class="text-center col-sm-12 form_alert"><i class="anticon anticon-loading"></i> please wait...</div>');
	...
	$(form2).submit(function (event) {
		...
		// show prograss loading
		$(formMessages2).html('<div class="text-center col-sm-12 form_alert"><i class="anticon anticon-loading"></i> please wait...</div>');
